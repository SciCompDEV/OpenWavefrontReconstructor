...
public:
   ...
   static void SaveDiffData2D(const vector<double> &xx,const vector<double> &yy,const vector<double> &zor,const vector<double> &zrec,\
           string fileName=string("temp2d.dat"));
};
/* ************************************************************************** */


#endif  /* _AUXILIARYTEMPORARYFUNCTIONS_H_ */
