...
public:
    ...
    static void SaveDiffData2D(const vector<double> &xx,const vector<double> &yy,const vector<double> &zor,const vector<double> &zrec, string fileName=string("temp2d.dat"));
    // Final gather
    static void SaveData3D_gathered(vector<double>&, vector<double>&, vector<double>&, vector<double>&, string, string, string, string);
    static void print_simu_param_gather(double, double, vector<double>&,vector<double>&, std::string, int, int);
};
